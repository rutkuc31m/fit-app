...
export default function Settings() {
  ...
  return (
    <div className="page page-settings">
      ...
      <AccentCard accent="#9a9a9a" className="p-4" contentClassName="pl-2 flex flex-col gap-3">
      ...
      {pushSupported() && (
        <>
          ...
          <AccentCard accent="#00d4aa" contentClassName="pl-2 flex flex-col gap-3">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="mono text-[.58rem] uppercase tracking-[.14em]"
                style={{ color: pushStatus === "subscribed" ? "#00d4aa" : pushStatus === "denied" ? "#ff6b9d" : "#6d6d70" }}>
                ...
                {PREF_ROWS.map(({ key, label, sub }) => (
                  <label key={key} className="flex items-center justify-between gap-3 py-2 border-b border-line/40 last:border-0 cursor-pointer">
                    ...
                    <button
                      ...
                      style={{ background: prefs[key] ? "#00d4aa" : "#3a3a3c" }}
