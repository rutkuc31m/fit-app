...
export default function Dashboard() {
  ...
  return (
    <div className="page page-dashboard">
          ...
          <div className="relative w-[124px] h-[124px] shrink-0">
            <svg viewBox="0 0 124 124" className="w-full h-full -rotate-90">
              ...
              <circle
                ...
                style={{ transition: "stroke-dashoffset .16s ease" }}
              />
            </svg>
      ...
      {/* Calorie ring + macros */}
      <AccentCard accent="#d9a441" className="p-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 grid grid-cols-3 gap-2">
            {[
              { k: "protein", v: macros.protein, t: target.protein, color: "#00d4aa" },
              { k: "carbs",   v: macros.carbs,   t: target.carbs,   color: "#9a9a9a" },
              { k: "fat",     v: macros.fat,     t: target.fat,     color: "#d9a441" }
            ].map((m) => {
      ...
      <div className="grid grid-cols-2 gap-[10px]">
        <AccentCard as={Link} to="/training" accent="#00d4aa" className="p-4 hover:border-line2 flex items-center gap-3" contentClassName="pl-2 flex items-center gap-3 w-full">
        ...
        <AccentCard as={Link} to="/log" accent="#d9a441" className="p-4 hover:border-line2">
      ...
      <AccentCard as={Link} to="/today" accent="#9a9a9a" className="hover:border-line2 flex items-center gap-2" contentClassName="pl-2 flex items-center gap-2 w-full">
      ...
      <AccentCard as={Link} to="/checkin" accent="#9a9a9a" className="hover:border-line2 flex items-center gap-2" contentClassName="pl-2 flex items-center gap-2 w-full">
      ...
      {meals.length === 0 ? (
        ...
        <div className="flex flex-col gap-2">
          {meals.map((m) => {
            ...
            return (
              <AccentCard key={m.id} accent="#d9a441" className="flex items-center gap-3" contentClassName="pl-2 flex items-center gap-3 w-full">
