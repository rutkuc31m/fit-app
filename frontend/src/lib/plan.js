...
export const PLAN = {
  ...
  phases: [
    ...
    { id: 2, nameKey: "phase2", weeks: [5, 12],  from: 88, to: 80, color: "#d9a441" },
    { id: 3, nameKey: "phase3", weeks: [13, 20], from: 80, to: 75, color: "#9a9a9a" },
    { id: 4, nameKey: "phase4", weeks: [21, 26], from: 75, to: 73, color: "#00d4aa" }
  ],
