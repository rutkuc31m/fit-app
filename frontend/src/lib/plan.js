...
export const PLAN = {
  ...
  phases: [
    { id: 1, nameKey: "phase1", weeks: [1, 4],   from: 93, to: 88, color: "#d9a441" },
    { id: 2, nameKey: "phase2", weeks: [5, 10],  from: 88, to: 80, color: "#d9a441" },
    { id: 3, nameKey: "phase3", weeks: [11, 18], from: 80, to: 75, color: "#9a9a9a" },
    { id: 4, nameKey: "phase4", weeks: [19, 24], from: 75, to: 73, color: "#00d4aa" }
  ],
