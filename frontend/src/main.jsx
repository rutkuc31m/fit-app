...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.err) {
      return (
        <div style={{ padding: 20, color: "#fbbf24", fontFamily: "monospace", fontSize: 12, whiteSpace: "pre-wrap", background: "#000000", minHeight: "100vh" }}>
          ...
          <button style={{ marginTop: 16, padding: "8px 16px", background: "#30d158", color: "#000000", border: "none", borderRadius: 8 }}
